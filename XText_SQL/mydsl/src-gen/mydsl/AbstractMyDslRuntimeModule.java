...
import mydsl.generator.MyDslGenerator;
import mydsl.parser.antlr.MyDslAntlrTokenFileProvider;
import mydsl.parser.antlr.MyDslParser;
import mydsl.parser.antlr.internal.InternalMyDslLexer;
import mydsl.scoping.MyDslScopeProvider;
import mydsl.serializer.MyDslSemanticSequencer;
import mydsl.serializer.MyDslSyntacticSequencer;
import mydsl.services.MyDslGrammarAccess;
import mydsl.validation.MyDslConfigurableIssueCodesProvider;
import mydsl.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "mydsl/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("mydsl.MyDsl");
	}
