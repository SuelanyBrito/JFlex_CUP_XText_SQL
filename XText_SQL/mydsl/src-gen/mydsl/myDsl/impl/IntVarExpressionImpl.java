 ...
 * </p>
 * <ul>
 *   <li>{@link mydsl.myDsl.impl.IntVarExpressionImpl#getVar <em>Var</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntVarExpressionImpl extends MinimalEObjectImpl.Container implements IntVarExpression
{
  /**
  ...
  {
    return MyDslPackage.Literals.INT_VAR_EXPRESSION;
  }
    ...
    if (var != null && var.eIsProxy())
    {
      ...
      if (var != oldVar)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDslPackage.INT_VAR_EXPRESSION__VAR, oldVar, var));
      }
    }
    return var;
  }
  ...
  public void setVar(VariableDeclaration newVar)
  {
    ...
    var = newVar;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INT_VAR_EXPRESSION__VAR, oldVar, var));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.INT_VAR_EXPRESSION__VAR:
