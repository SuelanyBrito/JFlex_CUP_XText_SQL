 ...
 * </p>
 * <ul>
 *   <li>{@link mydsl.myDsl.impl.VariableDeclarationImpl#getName <em>Name</em>}</li>
 *   <li>{@link mydsl.myDsl.impl.VariableDeclarationImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableDeclarationImpl extends ElementImpl implements VariableDeclaration
{
  ...
  public void setValue(int newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.VARIABLE_DECLARATION__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.VARIABLE_DECLARATION__NAME:
        return getName();
      case MyDslPackage.VARIABLE_DECLARATION__VALUE:
        return getValue();
    }
